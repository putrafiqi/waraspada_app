...
class TrenPenyebabStresUsahaWidget extends StatelessWidget {
  const TrenPenyebabStresUsahaWidget({
    super.key,
        ...
        children: [
          ...
          AspectRatio(
            ...
            child: BlocConsumer<
              ...
              TrenPenyebabStresUsahaState
            >(
              listener: (context, state) {
                if (state.status == TrenPenyebabStresUsahaStatus.failure) {
                  ShowToast.showEror(state.errorMessage ?? 'Terjadi kesalahan');
                }
              },
              builder: (context, state) {
                if (state.status == TrenPenyebabStresUsahaStatus.loading) {
                  return const Loader();
                }
